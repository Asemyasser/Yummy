...
function closeNavContent() {
  let innerWidth = $(".nav-content").innerWidth();
    ...
    cartoona += `
        <div class="col-md-3">
                <div onclick="getMealDetails('${arr[i].idMeal}')" class="meal position-relative overflow-hidden rounded-2 cursor-pointer">
                    ...
                    <div class="meal-layer position-absolute d-flex align-items-center text-black p-2 w-100 h-100 top-100">
                        <h3>${arr[i].strMeal}</h3>
                    </div>
                </div>
        </div>
  ...
  for (const cat of categories) {
    ...
    <div class="col-md-3">
      <div onclick="getCategoryMeals('${
        ...
        <img class="w-100" src="${cat.strCategoryThumb}" alt="" srcset="">
        <div class="meal-layer position-absolute text-center text-black p-2 w-100 h-100 top-100">
